        ...
        <table align = "center">
            <?php
                ...
                if (isset($_GET["limite"])) {
                    $limi = $_GET["limite"];
                    $sql = "SELECT c.*, u.*, t.*, e.nombre AS nombre_escuela, f.nombre AS nombre_facultad FROM tbcliente c
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $detalleLink = "vertramite_institucion.php?limite=$limi";
                        if (isset($r["idtramite"])) {
                            $detalleLink = "detalletramite_institucion.php?idtramite={$r["idtramite"]}";
                        }
                    ?>
        ...
        <center>
            <?php
                ...
                for ($i = 0; $i < $numpaginas; $i++) { 
                    $lim = $i * $cantidad;
                    echo "<a href='vertramite_institucion.php?limite=$lim' target='_parent'>".($i+1)."</a>&nbsp;&nbsp;&nbsp;"; 
                }
            ?>
        </center>
    </body>
