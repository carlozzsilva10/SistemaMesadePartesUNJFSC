...
<html lang = "en">
    ...
    <body>
        <br>
        <form action = "p_enviartramiteegresado.php" method = "post" enctype = "multipart/form-data" onsubmit = "return validarFormulario()">
            <table align = "center">
                <tr>
                    ...
                    <td>
                        <select name = "lstasunto" id = "lstasunto">
                            ...
                            <?php
                                $sql = "SELECT * FROM tbasunto WHERE idtipousuario = 4";
                                $fila = mysqli_query($cn, $sql);
