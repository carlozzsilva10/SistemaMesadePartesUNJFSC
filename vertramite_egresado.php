            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $detalleLink = "vertramite_egresado.php?limite=$limi";
                        if (isset($r["idtramite"])) {
                            $detalleLink = "detalletramite_egresado.php?idtramite={$r["idtramite"]}";
                        }
                    ?>
        ...
        <center>
            <?php
                ...
                for ($i = 0; $i < $numpaginas; $i++) { 
                    $lim = $i * $cantidad;
                    echo "<a href='vertramite_egresado.php?limite=$lim' target='_parent'>".($i+1)."</a>&nbsp;&nbsp;&nbsp;"; 
                }
            ?>
        </center>
    </body>
