...
<html lang = "en">
    ...
    <body>
        ...
        <center>
            <img src = "img/personal.png" width = "150" height = "150">
        </center>
        <h1>
            PERSONAL - TRÁMITES 2023
        </h1>
        ...
        <center>
            <div id = "cssmenu">
                <ul>
                    <li><a href = "principal_personal.php"><span>Principal</span></a></li>
                    <li class = "has-sub"><a href = "#"><span>Tus Datos</span></a>
                        <ul>
                            <li><a href = "actualizardatos_personal.php"><span>Actualizar Datos</span></a></li>
                            <li><a href = "imagenperfil_personal.php"><span>Insertar foto de Perfil</span></a></li>
                            <li class = "last"><a href = "cambiarpassword_personal.php"><span>Cambiar Password</span></a></li>
                        </ul>
                    </li>
                    <?php 
                        if ($r["estado"] == 1) {                  
                    ?>
                    <li><a href = "enviartramite_personal.php"><span>Enviar Trámite</span></a></li>
                    <li><a href = "vertramite_personal.php"><span>Ver Trámites</span></a></li>
                    <?php 
                        }
                    ?>
