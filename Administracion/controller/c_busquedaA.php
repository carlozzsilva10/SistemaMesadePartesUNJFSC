...
<html lang = "en">
    ...
    <body>
        ...
        <?php
            ...
            $valor = $_POST["valor"];
            $sql = "SELECT a.*, e.*, i.*, o.*, u.*, z.* FROM tbtramite a, tbcliente e, tbasunto i, tbdependencia o, tbtipousuario u, tbadministrador z
                        WHERE z.codadministrador = '$codigo' and z.iddependencia = a.iddependencia and a.estado != 'Enviado' and a.idcliente = e.idcliente AND a.idasunto = i.idasunto AND a.iddependencia = o.iddependencia AND e.idtipousuario = u.idtipousuario
