<?php
    ...
    $query = "SELECT c.estado, c.fecha_envio, t.razonsocial, c.nrotramite, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia, t.codigo AS codigo FROM tbtramite c
                    ...
                    WHERE c.estado != 'Enviado' AND z.codadministrador = '$codigo' AND c.fecha_envio BETWEEN '$fecha_inicio' AND '$fecha_fin' 
