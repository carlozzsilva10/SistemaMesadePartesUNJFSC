            ...
            <div class = "container">
                ...
                <table class = "formulario" align = "center" border = "2">
                    <?php
                        ...
                        $query = "SELECT c.estado, c.fecha_envio, c.nrotramite, t.razonsocial, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo , a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia FROM tbtramite c 
                ...
                <center class = "paginado">
                    <?php
                        ...
                        echo "<center><a href = 'expedientesA.php?pagina=1'>"  . 'Inicio' . " </a>";
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            echo "<a href = 'expedientesA.php?pagina=" . $i . "'> " . $i . " </a> ";
                        }
                        echo "<a href = 'expedientesA.php?pagina=$total_paginas'>"  . 'Final' . "</a></center>";
                    ?>
                </center>
            </div>
        </div>
