            ...
            <div class = "container">
                ...
                <table class = "formulario" align = "center" border= "2">
                    <?php
                        ...
                        $por_pagina = 5;
                        $empieza = max(($pagina - 1) * $por_pagina, 0); // Asegurarse de que $empieza no sea negativo
                        $query = "SELECT c.estado, c.fecha_envio, c.nrotramite, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia FROM tbtramite c
                                        ...
                                        WHERE c.estado = 'Recepcionado por el Área' AND z.codadministrador = '$codigo' 
                    ...
                    <tr align="center" class="cuerpo">
                        ...
                        <td>
                            <a href = "../controller/finalizar_estado.php?id=<?php echo $r["nrotramite"]; ?>" target = "_parent">
                                <center>
                ...
                <center class = "paginado">
                    <?php
                        ...
                        echo "<center><a href = 'expedientesP_area.php?pagina=1'>"  . 'Inicio' . " </a>";
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            echo "<a href = 'expedientesP_area.php?pagina=" . $i . "'> " . $i . " </a> ";
                        }
                        echo "<a href = 'expedientesP_area.php?pagina=$total_paginas'>"  . 'Final' . "</a></center>";
                    ?>
                </center>
            </div>
        </div>
