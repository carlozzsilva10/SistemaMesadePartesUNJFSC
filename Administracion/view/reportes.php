        ...
        <div class = "main-content" style = "padding: 0; background-color: #D1F2EB;">
            <div class = "container">
                ...
                <section align = "center">
                    <div id = "campos-fecha">
                        <form action = "rango_fecha.php" method = "post" accept-charset = "UTF-8">
                ...
                <table class = "formulario" align = "center" border = "2">
                    <?php
                        ...
                        $query = "SELECT c.nrotramite, c.fecha_envio, t.codigo, t.razonsocial, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia, c.estado FROM tbtramite c
                                        JOIN tbcliente t ON c.idcliente = t.idcliente
                                        JOIN tbasunto a ON c.idasunto = a.idasunto
                                        JOIN tbdependencia d ON c.iddependencia = d.iddependencia LIMIT $empieza,$por_pagina";
            ...
            <center class = "paginado">
                <?php
                    $query = "SELECT c.nrotramite, c.fecha_envio, t.codigo, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia, c.estado FROM tbtramite c
                                    JOIN tbcliente t ON c.idcliente = t.idcliente
                                    JOIN tbasunto a ON c.idasunto = a.idasunto
                    ...
                    echo "<center><a href = 'reportes.php?pagina=1'>"  . 'Inicio' . "</a>";
                    for ($i = 1; $i <= $total_paginas; $i++) {
                        echo "<a href = 'reportes.php?pagina=" . $i . "'> " . $i . " </a> ";
                    }
                    echo "<a href = 'reportes.php?pagina=$total_paginas'>"  . 'Final' . "</a></center>";
                ?>
            </center>
        </div>
    </body>
