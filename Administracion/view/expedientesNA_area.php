            ...
            <div class = "container">
                ...
                <center>
                    <div style = "display: inline-flex; align-content: center; align-items: center;">
                        <h1>Expedientes No Atendidos</h1>&nbsp;&nbsp;&nbsp;
                ...
                <table class = "formulario" align = "center" border = "2">
                    <?php
                        ...
                        $query = "SELECT c.estado, c.fecha_envio, c.nrotramite, CONCAT(t.appaterno, ' ', t.apmaterno, ' ', t.nombre) AS nombre_completo, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia FROM tbtramite c
                                        ...
                                        WHERE c.estado = 'Recepcionado' and z.codadministrador = '$codigo' 
                    ...
                    <tr align = "center" class = "cuerpo">
                        ...
                        <td>
                            <a href = "../controller/procesar_estado.php?id=<?php echo $r["nrotramite"];?>" target = "_parent">
                                <center>
                ...
                <center class = "paginado">
                    <?php
                        ...
                        echo "<center><a href = 'expedientesNA_area.php?pagina=1'>"  . 'Inicio' . " </a>";
                        for ($i = 1; $i <= $total_paginas; $i++) {
                            echo "<a href = 'expedientesNA_area.php?pagina=" . $i . "'> " . $i . " </a> ";
                        }
                        echo "<a href = 'expedientesNA_area.php?pagina=$total_paginas'>"  . 'Final' . "</a></center>";
                    ?>
                </center>
            </div>
        </div>
