    ...
    <body>
        ...
        <table align = "center">
            <?php 
                ...
                $sql = "SELECT razonsocial AS nombre_completo, t.nrotramite, t.descripcion AS descripcion_tramite, a.nombre AS nombre_asunto, d.nombre AS nombre_dependencia FROM tbcliente c
        ...
        <center>
            <button>
                <a class = "a" href = "vertramite_institucion.php">Volver</a>
            </button>
        </center>
    </body>
</html>
